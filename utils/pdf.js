...
function generateHeader(doc) {
    doc
        .image("Dola-logo.png", 50, 45, { width: 50 })
        .fillColor("#444444")
        .fontSize(20)
        .text("Dola Store", 110, 57)
        .fontSize(10)
        .text("Dola", 200, 50, { align: "right" })
        .text("90 Street", 200, 65, { align: "right" })
        .text("Egypt, new Cairo, 10025", 200, 80, { align: "right" })
        .moveDown();
}
